...
const WaterMaterial = [
    new THREE.MeshBasicMaterial({map: textureLoader.load('../../asserts/game/waternormals.jpg'), side: THREE.FrontSide}), // right
    new THREE.MeshBasicMaterial({map: textureLoader.load('../../asserts/game/waternormals.jpg'), side: THREE.FrontSide}), // left
    new THREE.MeshBasicMaterial({map: textureLoader.load('../../asserts/game/waternormals.jpg'), side: THREE.FrontSide}), // top
    new THREE.MeshBasicMaterial({map: textureLoader.load('../../asserts/game/waternormals.jpg'), side: THREE.FrontSide}), // bottom
    new THREE.MeshBasicMaterial({map: textureLoader.load('../../asserts/game/waternormals.jpg'), side: THREE.FrontSide}), // back
    new THREE.MeshBasicMaterial({map: textureLoader.load('../../asserts/game/waternormals.jpg'), side: THREE.FrontSide})  // front
];
